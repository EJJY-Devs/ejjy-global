...
exports.UnsoldItemContent = void 0;
const antd_1 = require("antd");
const dayjs_1 = __importDefault(require("dayjs"));
const react_1 = __importDefault(require("react"));
const Printing_1 = require("../../Printing");
const UnsoldItemContent = ({ unsoldItemSummary, branch, branchMachine, reportDate, }) => {
    const columns = [
        {
            title: 'Name',
            dataIndex: 'name',
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { className: "relative bg-white px-2 pt-2 text-center font-mono text-sm leading-4" },
            ...
            react_1.default.createElement("br", null),
            react_1.default.createElement("br", null),
            unsoldItemSummary.length === 0 ? (react_1.default.createElement("div", { className: "py-8 text-center" },
