...
const ViewXReadReportModal = ({ report, siteSettings, onClose, }) => {
    ...
    const { htmlPdf, isLoadingPdf, previewPdf, downloadPdf } = (0, hooks_1.usePdf)({
        ...
        image: (report === null || report === void 0 ? void 0 : report.gross_sales) === 0
            ...
            : undefined,
        print: () => (0, ejjy_global_1.printXReadReport)(report, siteSettings, report.branch_machine, report === null || report === void 0 ? void 0 : report.generated_by, true),
    });
    // METHODS
    const handlePrint = () => {
        (0, ejjy_global_1.printXReadReport)(report, siteSettings, report.branch_machine, report === null || report === void 0 ? void 0 : report.generated_by);
    };
    const handleCreateTxt = () => {
        setIsCreatingTxt(true);
        (0, ejjy_global_1.createXReadTxt)(report, siteSettings, report.branch_machine, report === null || report === void 0 ? void 0 : report.generated_by);
    ...
    return (react_1.default.createElement(antd_1.Modal, { className: "ViewReportModal", footer: [
        ...
        react_1.default.createElement(antd_1.Space, { className: "mt-6 w-100", direction: "vertical" },
            ...
            react_1.default.createElement(Printing_1.ReceiptReportSummary, { data: [
                    {
                        label: 'Beg Invoice #',
                        value: ((_a = report.beginning_or) === null || _a === void 0 ? void 0 : _a.or_number) || ejjy_global_1.EMPTY_CELL,
                    },
                    {
                        label: 'End Invoice #',
                        value: ((_b = report.ending_or) === null || _b === void 0 ? void 0 : _b.or_number) || ejjy_global_1.EMPTY_CELL,
                    },
                ] }),
            react_1.default.createElement(Text, { className: "w-100 mt-2 d-block" }, "SALES"),
            react_1.default.createElement(Printing_1.ReceiptReportSummary, { data: [
                    { label: 'Beg', value: (0, ejjy_global_1.formatInPeso)(report.beginning_sales) },
                    { label: 'Cur', value: (0, ejjy_global_1.formatInPeso)(report.gross_sales) },
                    { label: 'End', value: (0, ejjy_global_1.formatInPeso)(report.ending_sales) },
                ] }),
        ...
        react_1.default.createElement(Text, { className: "w-100 mt-6 text-center d-block" }, "CURRENT SALES BREAKDOWN"),
        react_1.default.createElement(antd_1.Descriptions, { className: "mt-6 w-100", colon: false, column: 1, contentStyle: {
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { label: "CASH SALES" },
                (0, ejjy_global_1.formatInPeso)(report.cash_sales),
                "\u00A0"),
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { label: "GROSS SALES" },
                (0, ejjy_global_1.formatInPeso)(report.gross_sales),
                "\u00A0")),
        react_1.default.createElement(antd_1.Descriptions, { className: "mt-6 w-100", colon: false, column: 1, contentStyle: {
                textAlign: 'right',
                display: 'block',
        ...
        react_1.default.createElement(antd_1.Descriptions, { className: "w-100", colon: false, column: 1, contentStyle: {
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { contentStyle: { fontWeight: 'bold' }, label: "NET SALES", labelStyle: { fontWeight: 'bold' } },
                (0, ejjy_global_1.formatInPeso)(report.net_sales),
                "\u00A0")),
        react_1.default.createElement("div", { className: "w-100", style: { textAlign: 'right' } }, "----------------"),
        react_1.default.createElement(antd_1.Descriptions, { className: "w-100", colon: false, column: 1, contentStyle: {
                textAlign: 'right',
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { label: "SC/PWD", labelStyle: { paddingLeft: 30 } },
                (0, ejjy_global_1.formatInPeso)(report.vat_special_discount),
                "\u00A0"),
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { label: "TOTAL", labelStyle: { paddingLeft: 30 } },
                (0, ejjy_global_1.formatInPeso)(report.total_vat_adjusted),
                "\u00A0")),
        react_1.default.createElement("div", { className: "w-100", style: { textAlign: 'right' } }, "----------------"),
        react_1.default.createElement(antd_1.Descriptions, { className: "w-100", colon: false, column: 1, contentStyle: {
                textAlign: 'right',
            ...
            react_1.default.createElement(antd_1.Descriptions.Item, { label: "VAT PAYABLE" },
                (0, ejjy_global_1.formatInPeso)(report.vat_payable),
                "\u00A0")),
        react_1.default.createElement(antd_1.Space, { className: "mt-6 w-100", direction: "vertical" },
            react_1.default.createElement(Text, null,
                ...
                report.generation_datetime
                    ? (0, ejjy_global_1.formatDateTime)(report.generation_datetime)
                    : ejjy_global_1.EMPTY_CELL),
            react_1.default.createElement(Text, null,
                "PDT:",
                ' ',
                report.printing_datetime
                    ? (0, ejjy_global_1.formatDateTime)(report.printing_datetime)
                    : ejjy_global_1.EMPTY_CELL)),
        react_1.default.createElement(antd_1.Space, { className: "mt-2 w-100 justify-space-between" },
            react_1.default.createElement(Text, null,
                "C: ",
                ((_c = report === null || report === void 0 ? void 0 : report.generated_by) === null || _c === void 0 ? void 0 : _c.employee_id) || ejjy_global_1.EMPTY_CELL),
            react_1.default.createElement(Text, null,
                "PB: ",
                ((_d = report === null || report === void 0 ? void 0 : report.generated_by) === null || _d === void 0 ? void 0 : _d.employee_id) || ejjy_global_1.EMPTY_CELL)),
