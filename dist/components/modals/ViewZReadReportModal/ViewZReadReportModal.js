...
const ViewZReadReportModal = ({ report, siteSettings, onClose, }) => {
    ...
    const { htmlPdf, isLoadingPdf, previewPdf, downloadPdf } = (0, hooks_1.usePdf)({
        ...
        image: report.total_transactions === 0
            ...
            : undefined,
        print: () => (0, ejjy_global_1.printZReadReport)(report, siteSettings, report.branch_machine, report === null || report === void 0 ? void 0 : report.generated_by, true),
    });
    // METHODS
    const handlePrint = () => {
        (0, ejjy_global_1.printZReadReport)(report, siteSettings, report.branch_machine, report === null || report === void 0 ? void 0 : report.generated_by);
    };
    const handleCreateTxt = () => {
        setIsCreatingTxt(true);
        (0, ejjy_global_1.createZReadTxt)(report, siteSettings, report.branch_machine, report.generated_by);
    ...
    return (react_1.default.createElement(antd_1.Modal, { className: "ViewReportModal", footer: [
        ...
        react_1.default.createElement(antd_1.Space, { className: "mt-6 w-100", direction: "vertical" },
            ...
            react_1.default.createElement(Printing_1.ReceiptReportSummary, { data: [
                    ...
                    { label: 'Cur', value: (0, ejjy_global_1.formatInPeso)(report.current_sales) },
