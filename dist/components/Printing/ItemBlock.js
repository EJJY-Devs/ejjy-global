...
const ItemBlock = ({ items }) => (react_1.default.createElement(antd_1.Descriptions, { className: "w-full", colon: false, column: 1, contentStyle: { textAlign: 'right', display: 'block' }, labelStyle: { width: 200 }, size: "small" }, items.map((item) => (react_1.default.createElement(antd_1.Descriptions.Item, { key: item.label, label: item.label, labelStyle: Object.assign({ paddingLeft: item.isIndented ? 30 : 0 }, item.labelStyle), contentStyle: item.contentStyle },
