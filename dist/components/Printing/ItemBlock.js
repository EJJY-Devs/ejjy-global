...
const ItemBlock = ({ items }) => (react_1.default.createElement("table", { style: { width: '100%' } },
    react_1.default.createElement("tbody", null, items.map((item) => (react_1.default.createElement("tr", { key: item.label },
