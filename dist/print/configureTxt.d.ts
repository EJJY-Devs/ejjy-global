import { BranchMachine, SiteSettings, Transaction, User, XReadReport, ZReadReport } from "types";
...
export declare const createDailySalesTxt: (dailySales: XReadReport, siteSettings: SiteSettings, user: User, branchMachine: BranchMachine) => null;
