import { BirReport, BranchMachine, CashBreakdown, CollectionReceipt, DailySales, GeneratedByUser, SiteSettings, Transaction, User, XReadReport, ZReadReport } from '../types';
