...
const printZReadReport = (report, siteSettings, user, isPdf = false) => {
    ...
    <table style="margin-left: 15px;">
      ...
      <tr>
        ...
        <td style="text-align: right;">${(0, utils_1.formatInPeso)(report.current_sales, helper_receipt_1.PESO_SIGN)}</td>
      </tr>
    ...
    <br/>
		...
		<table style="width: 100%;">
			...
			<tr>
				<td>CREDIT SALES</td>
				<td style="text-align: right">${(0, helper_receipt_1.formatInPesoWithUnderline)(report.credit_pay)}&nbsp;${(0, helper_receipt_1.addUnderline)(report.credit_pay)}</td>
			</tr>
			<tr>
				<td>GROSS SALES</td>
