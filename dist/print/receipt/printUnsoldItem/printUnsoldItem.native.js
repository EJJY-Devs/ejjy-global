...
exports.printUnsoldItemNative = void 0;
const dayjs_1 = __importDefault(require("dayjs"));
const helper_escpos_1 = require("../../helper-escpos");
const escpos_enum_1 = require("../../utils/escpos.enum");
const printUnsoldItemNative = ({ unsoldItemSummary, branch, branchMachine, reportDate, }) => [
    ...generateUnsoldItemContentCommands(unsoldItemSummary, branch, branchMachine, reportDate),
...
exports.printUnsoldItemNative = printUnsoldItemNative;
const generateUnsoldItemContentCommands = (unsoldItemSummary, branch, branchMachine, reportDate) => {
    ...
    if (unsoldItemSummary.length === 0) {
        commands.push(...(0, helper_escpos_1.printCenter)('No unsold items today'));
    }
    else {
        // Table Header
