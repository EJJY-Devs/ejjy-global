...
const printBirReport = (birReports, siteSettings, user, branchMachine) => {
    const rows = birReports.map((report) => {
        ...
        return (react_1.default.createElement("tr", null,
            ...
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.sc_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.pwd_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.naac_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.sp_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.others_discount, helper_receipt_1.PESO_SIGN)),
            ...
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.vat_sc_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.vat_pwd_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.vat_others_discount, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.vat_returns, helper_receipt_1.PESO_SIGN)),
            react_1.default.createElement("td", null, (0, utils_1.formatInPeso)(report.vat_others, helper_receipt_1.PESO_SIGN)),
            ...
            react_1.default.createElement("div", { className: "bir-reports-pdf" },
                ...
                react_1.default.createElement("table", { className: "bir-reports" },
                    react_1.default.createElement("tr", null,
                        ...
                        react_1.default.createElement("th", { rowSpan: 3 }, "Total Net Sales"),
