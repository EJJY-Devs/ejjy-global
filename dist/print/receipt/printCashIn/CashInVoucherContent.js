...
exports.CashInVoucherContent = void 0;
...
const CashInVoucherContent = ({ cashBreakdown, siteSettings, user, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Printing_1.ReceiptHeader, { branchMachine: cashBreakdown.branch_machine, title: constants_1.CASH_IN_VOUCHER_TITLE }),
        react_1.default.createElement("br", null),
        react_1.default.createElement("table", { style: { width: '100%', fontSize: '12px' } },
            react_1.default.createElement("tbody", null,
                react_1.default.createElement("tr", null,
                    react_1.default.createElement("td", { style: { width: '130px' } }, "Received From:"),
                    react_1.default.createElement("td", null, receivedFrom)),
                react_1.default.createElement("tr", null,
...
exports.CashInVoucherContent = CashInVoucherContent;
