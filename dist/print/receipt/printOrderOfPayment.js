...
const printOrderOfPayment = (orderOfPayment) => {
    ...
    const dataDom = server_1.default.renderToStaticMarkup(react_1.default.createElement("div", { className: "container", style: (0, helper_receipt_1.getPageStyleObject)({ padding: 24, width: 460 }) },
