...
const RequisitionSlipContent_1 = require("../../../components/modals/ViewRequisitionSlipModal/RequisitionSlipContent");
const helper_receipt_1 = require("../../helper-receipt");
const printRequisitionSlipHtml = ({ requisitionSlip, user, isPdf = false, }) => {
    const data = server_1.default.renderToStaticMarkup(react_1.default.createElement("div", { className: "container", style: (0, helper_receipt_1.getPageStyleObject)() },
        react_1.default.createElement(RequisitionSlipContent_1.RequisitionSlipContent, { requisitionSlip: requisitionSlip, user: user })));
    if (isPdf) {
