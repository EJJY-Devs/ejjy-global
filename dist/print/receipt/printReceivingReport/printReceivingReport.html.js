...
const ReceivingReportContent_1 = require("../../../components/modals/ViewReceivingReportModal/ReceivingReportContent");
const helper_receipt_1 = require("../../helper-receipt");
const printReceivingReportHtml = ({ receivingReport, isPdf = false, }) => {
    const data = server_1.default.renderToStaticMarkup(react_1.default.createElement("div", { className: "container", style: (0, helper_receipt_1.getPageStyleObject)() },
        react_1.default.createElement(ReceivingReportContent_1.ReceivingReportContent, { receivingReport: receivingReport })));
    if (isPdf) {
