...
export declare const useBranchMachineRetrieve: (data: UseRetrieveQuery<BranchMachine>) => import("react-query").UseMutationResult<BranchMachine, AxiosErrorResponse<any>, number, unknown>;
