...
const service = {
    ...
    retrieve: (id, baseURL) => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield axios_1.default.get(`/delivery-invoices/${id}/`, {
            baseURL,
        });
        return response.data;
    }),
    create: (body, baseURL) => __awaiter(void 0, void 0, void 0, function* () {
        return axios_1.default.post('/delivery-invoices/', body, {
            baseURL,
        });
    }),
};
