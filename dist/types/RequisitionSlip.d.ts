...
type RequisitionSlipAction = {
    ...
    action: 'new' | 'seen' | 'f_os1_creating' | 'f_os1_created' | 'f_os1_preparing' | 'f_os1_prepared' | 'f_ds1_creating' | 'f_ds1_created' | 'f_ds1_delivering' | 'f_ds1_delivered_done' | 'f_ds1_delivered_error' | 'out_of_stock';
};
...
type RequisitionSlipRequestingUser = {
    branch: Branch;
} & Pick<User, 'email' | 'username' | 'user_type' | 'first_name' | 'last_name' | 'profile_pic' | 'display_name' | 'contact_number'>;
